...
if (global.config.loggly && global.config.loggly.token && global.config.loggly.subdomain) {
   console.warn('loggly subdomain', global.config.loggly.subdomain);
   exports.logglyClient = require('loggly').createClient({
...
export default function chronicaLogger(options) {
   let that = {};
   ...
   function log(level, message, data) {
      if (isLoggable(level)) {
         ...
         if (exports.logglyClient) {
            exports.logglyClient.log(record, tags);
         }
      }
   }
